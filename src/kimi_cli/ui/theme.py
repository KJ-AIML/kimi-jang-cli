    ...
    return PTKStyle.from_dict(
        {
            ...
            "header.title": "bg:#1f2937 #7F00FF bold",
            ...
            "status.info": "bg:#1f2937 #9F4FFF",
            "task-list": "bg:#111827 #d1d5db",
            "task-list.checked": "bg:#164e63 #ecfeff bold",
            "frame.border": "#7F00FF",
            "frame.label": "bg:#0f172a #7F00FF bold",
            "footer": "bg:#0f172a #cbd5e1",
            "footer.key": "bg:#0f172a #7F00FF bold",
    ...
    return PTKStyle.from_dict(
        {
            ...
            "header.title": "bg:#e5e7eb #7F00FF bold",
            ...
            "status.info": "bg:#e5e7eb #7F00FF",
            "task-list": "bg:#f9fafb #374151",
            "task-list.checked": "bg:#cffafe #164e63 bold",
            "frame.border": "#7F00FF",
            "frame.label": "bg:#f1f5f9 #7F00FF bold",
            "footer": "bg:#f1f5f9 #475569",
            "footer.key": "bg:#f1f5f9 #7F00FF bold",
...
_PROMPT_STYLE_DARK = {
    ...
    "slash-completion-menu.marker.current": "fg:#7F00FF",
    "slash-completion-menu.command": "fg:#a6adba",
    "slash-completion-menu.meta": "fg:#7c8594",
    "slash-completion-menu.command.current": "fg:#7F00FF bold",
    "slash-completion-menu.meta.current": "fg:#9F4FFF",
}
...
_TOOLBAR_DARK = ToolbarColors(
    ...
    plan_label="bold fg:#7F00FF",
    plan_prompt="fg:#7F00FF",
    cwd="fg:#666666",
    bg_tasks="fg:#888888",
    tip="fg:#555555",
)
